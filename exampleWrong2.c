...
int soma_int(int a, int b) {
    ...
    return;             //  ERRO: retorno sem valor em função int (se MINI tratar isso) 
}
...
int helper(int h) {
    ...
    return;             //  ERRO: retorno vazio em função int (se aplicável) 
}
